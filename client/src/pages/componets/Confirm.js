    ...
    <>
      ...
      >
        ...
        <div className="col-lg-12 mx-auto">
          <p className="lead">
            <b>
              {formValues.company1},- {formValues.company1designation}
            </b>{" "}
        ...
        <div className="col-lg-12 mx-auto">
          <p className="lead">
            <b>
              {formValues.company2},{formValues.company2designation}
            </b>{" "}
        ...
        <div className="col-lg-12 mx-auto">
          <p className="lead">
            <b>{formValues.project1}</b>({formValues.project1fromyear1}-
